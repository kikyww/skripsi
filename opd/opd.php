        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                    <?php
                    $query = mysqli_query($konek, "SELECT * FROM tb_opd ORDER BY nama_opd ASC");
                    $no = 0;
                    ...
                    echo"
                        <tr>
                            ...
                            <a href='delete.php?id=$row[0]' onclick='return confirm(\" Hapus $row[nama_opd]?\");' class='btn icon btn-danger'><i class='bi bi-trash'></i></a>
                            </td>
                        </tr>";
                    }?>
                    </tbody>
