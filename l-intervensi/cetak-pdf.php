<?php 
    ...
    if (isset($_POST['submit'])) {
        if(isset($start_date) && isset($end_date) && isset($filKecamatan) && isset($filKelurahan)){
...
<div style="display:flex;">
    <div style="justify-content: center; align-items: center; margin:auto;">
        <p style="font-size:22px; font-weight: bold; text-align:center;">Ringkasan Intervensi</p>
